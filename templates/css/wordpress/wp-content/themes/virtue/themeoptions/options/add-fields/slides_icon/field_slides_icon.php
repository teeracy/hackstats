...
if (!class_exists('ReduxFramework_kad_icons')) {
    ...
    class ReduxFramework_kad_icons extends ReduxFramework
    {
        ...
        public function render() {
            ...
            if (isset($this->value) && is_array($this->value)) {
                ...
                foreach ($slides as $slide) {
                    ...
                    echo '</div>' . "\n";
                    echo '<select id="' . $this->field['id'] . '-select_'. $x .'" data-placeholder="'.__('Choose Icon', 'virtue') .'" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][icon_o]" class="redux-select-item font-icons" rows="6">';
                    echo '<option></option>';
                    ...
                    echo '</select>';
                    echo '<ul id="' . $this->field['id'] . '-ul" class="redux-multi-text">';
                    echo '<li><input type="hidden" id="' . $this->field['id'] . '-url_' . $x . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][url]" value="' . esc_attr($slide['url']) . '" class="full-text" placeholder="'.__('Image URL', 'virtue').'" /></li>';
                    ...
                    echo '<li><input type="hidden" class="slide-sort" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][sort]" id="' . $this->field['id'] . '-sort_' . $x . '" value="' . $slide['sort'] . '" /></li>';
                    echo '<li><input type="hidden" class="upload-id" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][attachment_id]" id="' . $this->field['id'] . '-image_id_' . $x . '" value="' . $slide['attachment_id'] . '" /></li>';
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion kad-redux-icons-remove">' . __('Delete Icon', 'virtue') . '</a></li>';
            ...
            if ($x == 0) {
                echo '<div class="redux-slides-accordion-group"><fieldset class="redux-field"><h3><span class="redux-slides-header">'.__("New Icon", "virtue").'</span></h3><div>';
            ...
            echo '</div><a href="javascript:void(0);" class="button kad-redux-icons-add button-primary" rel-id="' . $this->field['id'] . '-ul" rel-name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][title][]">' . __('Add Icon', 'virtue') . '</a><br/>';
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                'redux-field-slides-link-js',
                ReduxFramework::$_url . 'options/add-fields/slides_icon/field_slides_icon.js',
            ...
            wp_enqueue_style(
                ...
                ReduxFramework::$_url . 'options/add-fields/slides_icon/field_slides_icon.css',
                time(),
                true
            );
