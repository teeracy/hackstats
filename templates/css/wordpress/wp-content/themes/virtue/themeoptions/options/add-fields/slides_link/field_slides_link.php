...
if (!class_exists('ReduxFramework_kad_slides')) {
    ...
    class ReduxFramework_kad_slides extends ReduxFramework
    {
        ...
        public function render() {
            ...
            if (isset($this->value) && is_array($this->value)) {
                ...
                foreach ($slides as $slide) {
                    ...
                    echo '<li><input type="text" id="' . $this->field['id'] . '-url_' . $x . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][url]" value="' . esc_attr($slide['url']) . '" class="full-text" placeholder="'.__('Image URL', 'virtue').'" /></li>';
                    ...
                    echo '<li><a href="javascript:void(0);" class="button deletion kad-redux-slides-remove">' . __('Delete Slide', 'virtue') . '</a></li>';
            ...
            if ($x == 0) {
                ...
                echo '<ul id="' . $this->field['id'] . '-ul" class="redux-multi-text">';
                echo '<li><input type="text" id="' . $this->field['id'] . '-url_' . $x . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][url]" value="' . esc_attr($slide['url']) . '" class="full-text" placeholder="'.__('Image URL', 'virtue').'" /></li>';
                echo '<li><input type="text" id="' . $this->field['id'] . '-title_' . $x . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][title]" value="" placeholder="'.__('Title', 'virtue').'" class="full-text slide-title" /></li>';
                echo '<li><textarea name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][description]" id="' . $this->field['id'] . '-description_' . $x . '" placeholder="'.__('Description', 'virtue').'" class="large-text" rows="6"></textarea></li>';
                echo '<li><input type="text" id="' . $this->field['id'] . '-link_' . $x . '" name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][' . $x . '][link]" value="' . esc_attr($slide['link']) . '" placeholder="'.__('Slide Link', 'virtue').'" class="full-text" /></li>';
            ...
            echo '</div><a href="javascript:void(0);" class="button kad-redux-slides-add button-primary" rel-id="' . $this->field['id'] . '-ul" rel-name="' . $this->args['opt_name'] . '[' . $this->field['id'] . '][title][]">' . __('Add Slide', 'virtue') . '</a><br/>';
        ...
        public function enqueue() {
            ...
            wp_enqueue_script(
                'redux-field-slides-link',
                ReduxFramework::$_url . 'options/add-fields/slides_link/field_slides_link.js',
            ...
            wp_enqueue_style(
                ...
                ReduxFramework::$_url . 'options/add-fields/slides_link/field_slides_link.css',
                time(),
                true
            );
